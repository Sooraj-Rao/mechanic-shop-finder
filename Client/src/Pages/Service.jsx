      ...
      >
        {load.one ? (
          ...
          shopsList.map((item, index) => {
            return (
              <div
                className={`lg:h-[20rem] h-fit  rounded-lg 
            w-full 
            
            p-4 flex flex-col lg:flex-row
            text-white
            my-3
          ...
          `}
                key={index}
              >
                <div className=" mx-6  h-full sm:min-w-[20rem] w-[10rem] self-center overflow-hidden bg-slate-400 rounded-md  ">
                ...
                <div className=" relative">
                  <div className=" text-xl pt-4  text-center flex   justify-around" >
                    ...
                    <button
                      disabled={load.two && item._id == serviceid}
                      className="  w-40 py-2 lg:block hidden    text-white text-base"
                  ...
                  <button
                    className=" px-4 py-2 my-5 lg:hidden text-white text-base"
                    onClick={() => BookService(item._id)}
                  >
                    <h1>
                      {load.two && item._id == serviceid ? (
                  ...
                  <h2 className="  lg:absolute bottom-0 text-gray-400">Order can be canceled within 5 hours</h2>
                </div>
              </div>
            );
          })
